...
declare class ThreeGlobeGeneric<ChainableInstance> extends Object3D {
  ...
  widthSegments(): ObjAccessor<number>;
  widthSegments(widthSegmentsAccessor: ObjAccessor<number>): ChainableInstance;
  heightSegments(): ObjAccessor<number>;
  heightSegments(heightSegmentsAccessor: ObjAccessor<number>): ChainableInstance;
  _destructor(): void;
}
